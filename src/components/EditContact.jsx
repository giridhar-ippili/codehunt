...
export default function EditContact(props) {
  ...
  return (
    <div>
     <IconButton className="edit-icon" onClick={handleClickOpen}><EditIcon/></IconButton>
      ...
      <DialogContent>        
        ...
        <DialogActions className="actions">
            ...
            <Button  type="submit" variant="outlined" color="primary" >Edit Contact</Button>            
          </div>
        </DialogActions>        
        </form>
      </Dialog>
